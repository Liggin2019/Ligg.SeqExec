...
class CBase64  { 
	...
	class TempBucket { 
	public: 
		BYTE nData[4]; BYTE nSize;
		void Clear() { ::ZeroMemory(nData, 4); nSize = 0; }; };  
		PBYTE m_pDBuffer; PBYTE m_pEBuffer; DWORD m_nDBufLen; DWORD m_nEBufLen; DWORD m_nDDataLen; DWORD m_nEDataLen;
public:CBase64();
	   virtual ~CBase64();
...
protected: 
	...
	static char m_DecodeTable[256]; static BOOL m_Init; 
	void _Init();
};
